...
print('avg_grade:', round(avg_grade,2))
print('attendance:', str(round((attendance * 100), 2))+'%')

if(avg_grade>=6 and attendance>=0.8): #the two arguments must through for AND operator, for OR operator, only one test must be true
